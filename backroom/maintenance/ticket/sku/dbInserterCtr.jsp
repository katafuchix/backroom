...
<%
	...
	if( sku.isError() ){
		TicketSkuhandler ticketskuhandler = new TicketSkuhandler();
		ticketskuhandler.setDataSource( Datasouce );
		dbflag = ticketskuhandler.addTicketSku( sku );
		ticketskuhandler = null;
	}
%>
<html>
