...
%>
	<form action="/backroom/maintenance/amuse/allot/productInserterCtr.jsp" method="post">
...
<%
        ...
        <table width="100%" border="1" cellspacing="1" cellpadding="1">
          ...
          <tr bgcolor="#CCCCCC">
            ...
            <td  class="b" align="center" width="260">公演名<br/>商品名</td>
            <td  class="b" align="center" width="40">在庫</td>
            <td align="center" class="b" width="100">公演日/公演時間</td>
...
%>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td align="left"><%= allot.product_name %><br/><%= allot.sku_name %></td>
