...
%>
				<table width="100%" border="0" cellspacing="1" cellpadding="2">
					...
					<tr bgcolor="#999999">
						<td colspan="9" align='center' class="b">公演日/開始時間・ステータス</td>
          </tr>
          <tr>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <input type='text' size='4' maxlength='3' name='allotcounter' value='<%= allot.allotcounter %>' style='ime-mode:disabled;' /></td>
            ...
            <input type='text' size='6' maxlength='4' name='allottime' value='<%= allot.allottime %>' style='ime-mode:disabled;' />
