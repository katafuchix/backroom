...
<%
	...
	boolean resultFlag = handlersupnbr.addLocalAreaSubNbr( temp );
...
<head>
<%	if( resultFlag ){	%>
<%=	jp.co.lastminute.maintenance.util.WebUtil.getAlert("’Ç‰Á‚µ‚Ü‚µ‚½") %><%	}else{	%>
<%=	jp.co.lastminute.maintenance.util.WebUtil.getAlert("’Ç‰Á‚É¸”s‚µ‚Ü‚µ‚½") %><%	}	%>
