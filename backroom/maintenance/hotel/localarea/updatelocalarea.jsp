...
<%
	...
	temp.getRequestByUpdate(request);
	boolean error = handler.updateLocalArea( temp );
	if( error ){
		out.println(jp.co.lastminute.maintenance.util.WebUtil.getAlert("更新しました"));
	}else{
		out.println(jp.co.lastminute.maintenance.util.WebUtil.getAlert("更新に失敗しました"));
	}
