...
<%
  ...
  //カテゴリー
	...
	//
	int pagetype_cd = type_cd * 100 + jp.co.lastminute.maintenance.Property.PURPOSE_;
	page_type_cd = jp.co.lastminute.maintenance.Property.PURPOSE_;
  ...
  <tr>
    <td>
      <table border="0" cellspacing="1" cellpadding="2" width="100%">
        <tr align="center">
          <td colspan="5" bgcolor="#FFFFFF">ギフト管理画面</td>
        </tr>
        <%
		int end = 4;
		for(int i=0; i<end; i++){
