...
<%
  ...
  //カテゴリー
	...
	Restraunt pagelist = new Restraunt();
	pagelist.init( Datasouce );
	//
	int pagetype_cd = type_cd * 10 + jp.co.lastminute.maintenance.Property.INDEX_;
  ...
  <tr>
    <td>
      <table border="0" cellspacing="1" cellpadding="2" width="100%">
        <tr align="center">
          <td colspan="5" bgcolor="#FFFFFF">レストラン管理画面</td>
        </tr>
        <%
		int end = 7;
		for(int i=0; i<end; i++){
...
%>
        ...
        <tr>
          ...
          <input type="text" name="description" maxlength='25' size="40" value="<%= select.getDescription() %>">
          </td>
        </tr>
        <tr>
