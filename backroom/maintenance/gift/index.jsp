...
<form name='MainForm' method='post' action="/backroom/maintenance/gift/info/insertForm.jsp">
    ...
    <td bgcolor="#999999">
        <table width="100%" border="0" cellspacing="1" cellpadding="2">
          ...
          <tr bgcolor="#CCCCCC">
            ...
            <td align="center" class="b">商品名 (全角50文字以内)</td>
...
<%= WebUtil.getComboByList( agents, "" ) %>
            ...
            <td align="center">
              <input size=50 name = "product_name" maxlength=50 class="textbox">
            </td>
            <td align="center">
