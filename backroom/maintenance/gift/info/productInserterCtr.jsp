  ...
  <table width="500" border="0" cellpadding="0" cellspacing="0" align="left">
    ...
    <tr>
    	<td bgcolor="#FFFFFF" align="left">
     		<BR>
				<input type="submit" onClick="return doUpdate();" value="＞登録する＞">
    	</td>
  	</form>

		<form name='ToForm' method='post' action='insertForm.jsp'>
			<input type='hidden' name='product_type' value='<%= type_cd %>' >
		    ...
		    <td bgcolor="#FFFFFF" align="right">
					<BR>
					<!--<input type="submit" onClick="return doUpdate();" value="＜ 戻る ＜">-->
...
<jsp:include page="form.jsp" />
    	...
    	<tr>
    		<td bgcolor="#FFFFFF" align="center">
     		<input type="submit" onClick="return doUpdate();" value="＞確認する＞">
    		</td>
  		</tr>
	</table>
</form>
