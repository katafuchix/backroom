...
<%
	...
	if( giftinfo.isError() ){
		...
		dbflag = giftInfohandler.updateGiftInfo( giftinfo );
...
<body bgcolor = "white" onload="PopUpWriteGift('<%= giftinfo.jan_cd %>','Gift');">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    <td bgcolor="#FFFFFF">
      ...
      <input type="submit" value = "サプライヤー別管理へ" name="btnAdd"/>
        ...
        <input type='submit' value='データを入れ直す'>
			</form><br>

			<A HREF="javascript:PopUpWriteGift('<%= giftinfo.jan_cd %>','Gift');">コンテンツの更新へ</a>
			<br/><br/>

			<A HREF="http://www.lastminute.co.jp/lmj/Gift/detail.do?catid=93&product_id=<%= giftinfo.jan_cd %>" target="_blank">本番ページへ</a>
