...
<img src='/<%= ContextProperty._ticket_image_Dir %><xml:out select='$pageamount//product_seq'/>-4.gif' width='200' height='200'>
			</td>
...
<!-- チケット詳細 -->
          ...
          <tr>
           <td BGCOLOR="#EEEEEE" CLASS="b" VALIGN="TOP" WIDTH="100">公演日</td>
           <td BGCOLOR="#FFFFFF" WIDTH="200"><xml:out select='$pageamount//opening'/>
           </td>
          </tr>
          <tr>
