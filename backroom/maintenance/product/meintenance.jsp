...
<head>
<title>メンテナンス</title>
<link REL="stylesheet" HREF="http://www.lastminute.co.jp/basic.css" TYPE="TEXT/CSS">
</head>
<body BGCOLOR="#FFFFFF" TEXT="#000000" LEFTMARGIN="0" TOPMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0">
<form action="./update.jsp" method="post">
	<input type="hidden" name="product_seq" value="<%= condition.product_seq %>">
	<input type="hidden" name="catClass" value="<%= condition.catClass %>">
	<input type="submit" value="データを反映する">
</form>
<input type=hidden value="<%= includfile %>">
